...
export const LoaderFour = ({className ,text = "Loading..." }: { className?: string,text?: string }) => {
  return (
    <div className={`relative font-bold text-black [perspective:1000px] dark:text-white ${className}`}>
      ...
      <motion.span
        className={`absolute inset-0 text-[#00e571]/50 blur-[0.5px] dark:text-[#00e571] ${className}`}
        animate={{
          x: [-2, 4, -3, 1.5, -2],
          y: [-2, 4, -3, 1.5, -2],
      ...
      <motion.span
        className={`absolute inset-0 text-[#8b00ff]/50 dark:text-[#8b00ff] ${className}`}
        animate={{
          x: [0, 1, -1.5, 1.5, -1, 0],
          y: [0, -1, 1.5, -0.5, 0],
