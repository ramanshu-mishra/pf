...
export default function Home() {
 ...
 function getRelativeCoordinates(event:React.MouseEvent, referenceElement: HTMLSpanElement) {
...
const handleMouseMove = (e:React.MouseEvent) => {
  ...
  return (
    ...
    <div ref={scope} className="min-h-screen w-[100vw] bg-neutral-950 flex justify-center items-center pointer " onMouseMove={(e)=>{
      ...
      <motion.span className="w-4 h-4 bg-white rounded-full absolute left-0 top-0 z-49 " style={{pointerEvents: "none"}} 
